...
- (id)initWithFile:(NSString *)fileName
{
    if((self = [super init]))
    {
        ...
        [[ZTextureManager sharedManager] loadImage:fileName];
        _texture = [[ZTextureManager sharedManager] findTextureByFilename:fileName];
...
{
    ZSprite* newSprite = [super copyWithZone:zone];
    if(newSprite)
    {
