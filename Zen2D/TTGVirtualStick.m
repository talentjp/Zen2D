...
@implementation TTGVirtualStick
...
- (id)init
{
    if((self = [super init]))
    {
        ...
        _leftAnalogCircle = [[TTGSprite alloc] initWithFile:@"LeftAnalog.png"];
        _leftThumbCircle  = [[TTGSprite alloc] initWithFile:@"LeftAnalogThumb.png"];
        _rightButtonA     = [[TTGSprite alloc] initWithFile:@"ButtonA.png"];
